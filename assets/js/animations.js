...
export function observeAll(){document.querySelectorAll('.page.active .reveal, .page.active .counter, footer .reveal, .cta-band').forEach(el=>{io?io.observe(el):(el.classList.add('in'),runCounters(el))})}
